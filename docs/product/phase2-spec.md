...
**Cross-proxy consistency.** То же что в Phase 1: после PR-merge доставка через Puppet занимает минуты, в окне разные эдж-нода могут видеть разные версии каталога. Это допустимо.
