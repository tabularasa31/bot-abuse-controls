...
| Сущность | Определение |
| --- | --- |
| **gate (гейт)** | порог допуска к блокировке: про безопасность блока (не заденет ли невиновных под тем же fp), а не про то, бот ли это. Гейты НЕ складываются и НЕ компенсируют друг друга. Жёсткие (вето) — бот-онли/доверенные/known-good/решение челленджей — не перебиваются даже вручную; мягкие — объём/дубль — останавливают только авто-промоут, человек может форснуть. |
