...
| позитивный каталог браузеров (`tls_fp_browser_profiles`) | белый список «известно-хороших» отпечатков браузеров                                                          | гейт known-good (настоящий браузер → не блокировать), сигнал расхождения версий |
