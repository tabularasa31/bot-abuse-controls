...
2. **Скоринг.** Воркер читает Loki за последние 7 дней и за один проход считает вердикт по
каждой сигнатуре на всех стадиях её жизненного цикла:
   ...
   Выход — два: (а) **машинные артефакты** с вердиктом по каждой сигнатуре (их читает автомат
   на шаге 3); (б) **человекочитаемый отчёт** ответственному на почту. Сам каталог воркер не
   трогает.
