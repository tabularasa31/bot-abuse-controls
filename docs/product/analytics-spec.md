...
- Пройден, если под сигнатурой за все время накопилось ≥ 20 событий (счетчик из накопителя);
меньше — придержать. Это мягкий гейт: по паре случайных запросов решение не принимают.
