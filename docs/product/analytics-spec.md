...
самые последние 7 дней из Loki, что воркер читает за прогон). Исключение — гейт «объем»: он
смотрит не на окно, а на счетчик за все время из накопителя (7 дней мало, чтобы судить об
объеме). По шагам:
