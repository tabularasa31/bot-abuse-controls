...
То, что непройденный гейт перебивает любую оценку, — общее свойство всех гейтов (см.
выше). Пометка «вето» добавляет к этому ровно одно: такой гейт не перебивает даже человек
вручную. Разница не в отношении к оценке (тут гейты одинаковы), а в отношении к человеку:

- **Вето** (бот-онли, доверенные, known-good, решение челленджей) — за ними живые
пользователи и легитимный трафик; обойти такой гейт значит сознательно заблокировать
невиновных, поэтому его не перебивают и руками.
- **Мягкие** (объем, дубль) — про качество данных, а не про безопасность; они лишь
придерживают автомат (мало данных / дубль), никого конкретного не защищают, поэтому
человек на ревью может осознанно пропустить сигнатуру дальше.
