...
- **Мягкие** (объем, дубль) — про качество данных, а не про безопасность. Провести
сигнатуру мимо такого гейта вручную — рядовое осознанное решение оператора (мало данных,
но он уверен).
- **Вето** (бот-онли, доверенные, known-good, решение челленджей) — про безопасность: за
ними живые пользователи и легитимный трафик. Пройти мимо вето вручную = сознательно
заблокировать невиновных. Технически человека ничто не держит, но это красная черта, а не
рядовая операция — так не делают.
...
Каждый гейт — простой детерминированный расчет по событиям сигнатуры за окно. По шагам:
